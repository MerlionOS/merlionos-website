...
template: splash
hero:
  tagline: "Born for AI. Built by AI. — v100: 132,670 lines of Rust, self-hosting, 4 CPU architectures."
  actions:
    - text: Get Started
...
<CardGrid>
  ...
  <Card title="360 Modules, 133K Lines" icon="document">
...
- **100 releases** from v1 through v100

## Projects

<CardGrid>
  <Card title="merlion-kernel" icon="seti:rust">
    General-purpose hobby OS kernel. 360 modules, 4 architectures, 480+ shell commands.
