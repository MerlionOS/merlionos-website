...
template: splash
hero:
  tagline: "Born for AI. Built by AI. — Ring 3 userspace, 140K lines of Rust, self-hosting, 4 CPU architectures."
  actions:
    - text: Get Started
...
<CardGrid>
  ...
  <Card title="380 Modules, 140K Lines" icon="document">
  ...
  <Card title="480+ Shell Commands" icon="laptop">
...
- **Ring 3 userspace** with ELF loader, per-process page tables, 45 POSIX syscalls, and 5 built-in user programs
...
- **Self-hosting** — Rust subset compiler, x86_64 assembler, ELF linker — the OS can compile itself
- **100+ releases** from v1 through v100 and beyond

## Projects

<CardGrid>
  <Card title="merlion-kernel" icon="seti:rust">
    General-purpose hobby OS kernel. 380 modules, 4 architectures, 480+ shell commands.
